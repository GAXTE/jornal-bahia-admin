...
function DashboardCard07() {
  return (
    <div className="col-span-1 sm:col-span-2 lg:col-span-8 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      <header className="px-4 sm:px-5 py-3 sm:py-4 border-b border-slate-100 dark:border-slate-700">
        <h2 className="text-base sm:text-lg font-semibold text-slate-800 dark:text-slate-100">Top Channels</h2>
      </header>
